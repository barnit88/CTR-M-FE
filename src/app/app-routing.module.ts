...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: "peb-payment-transaction",
        component: PebpaymenttransctionlistComponent,
      },
      {
        path: "pee-payment-transaction",
        component: PeepaymenttransctionlistComponent,
      },
      ...
      {
        path: "pvi-payment-transaction",
        component: PvipaymenttransctionlistComponent,
      },
      {
